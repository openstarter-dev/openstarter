...
export const mdxComponents: MDXComponents = {
  h1: (props) => (
    <h1
      className="mt-2 mb-6 font-bold text-3xl tracking-tight"
      {...props}
    />
  ),
  h2: (props) => (
    <h2
      className="mt-10 mb-4 border-b pb-2 font-semibold text-2xl tracking-tight"
      {...props}
    />
  ),
  h3: (props) => (
    <h3 className="mt-8 mb-3 font-semibold text-xl tracking-tight" {...props} />
  ),
