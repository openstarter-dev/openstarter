...
import { EmailLayout, ExpiryNote, Footnote, OtpCode, Paragraph, Title } from "./layout";
...
const copy = {
  ...
  zh: {
    preview: "你的登录验证码",
    title: "你的登录验证码",
    intro: (app: string) => `请输入下方验证码以登录 ${app}。请勿将其分享给任何人。`,
...
export const SignInOtpEmail = ({ otp, locale, appName = "OpenStarter" }: SignInOtpEmailProps) => {
